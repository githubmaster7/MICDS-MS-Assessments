    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4 py-12">
        <div className="mb-8 text-center">
          <div className="inline-flex items-center justify-center w-14 h-14 rounded-xl bg-primary-700 shadow-md mb-4">
            <span className="text-white font-bold text-xl tracking-tight">PE</span>
          </div>
